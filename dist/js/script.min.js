...
function Tuple() {
    this.relation_name = void 0, this.values = [];
}
...
BaseRelation.prototype.eval = function() {
    ...
    for (var i = 0; i < left_res.length; i++) for (var j = 0; j < right_res.length; j++) {
        var old_left = left_res[i], old_right = right_res[j], new_tuple = {};
        for (var name in old_left) new_tuple[name] = old_left[name];
        for (var name in old_right) new_tuple[name] = old_right[name];
        console.log(new_tuple), this.result.push(new_tuple);
    }
    ...
    console.log("======="), console.log("starting projecting the following tuple"), 
    console.log(tuple), console.log("with indeces to stay = "), console.log(this.indecesToStay);
    var newt = new Tuple();
    console.log(this.relation.result.attributes);
    for (var i = 0; i < tuple.values.length; i++) -1 != this.indecesToStay.indexOf(i) && newt.values.push(tuple.values[i]);
    return console.log("results in:"), console.log(newt), console.log("-------"), newt;
    ...
    function parse(input) {
        ...
        function peg$parsecross() {
            var s0, s1, s2, s3, s4, s5, key = 17 * peg$currPos + 15, cached = peg$cache[key];
            return cached ? (peg$currPos = cached.nextPos, cached.result) : (s0 = peg$currPos, 
            40 === input.charCodeAt(peg$currPos) ? (s1 = peg$c56, peg$currPos++) : (s1 = peg$FAILED, 
            0 === peg$silentFails && peg$fail(peg$c57)), s1 !== peg$FAILED ? (s2 = peg$parserelation(), 
            s2 !== peg$FAILED ? (input.substr(peg$currPos, 8) === peg$c58 ? (s3 = peg$c58, peg$currPos += 8) : (s3 = peg$FAILED, 
            0 === peg$silentFails && peg$fail(peg$c59)), s3 !== peg$FAILED ? (s4 = peg$parserelation(), 
            s4 !== peg$FAILED ? (41 === input.charCodeAt(peg$currPos) ? (s5 = peg$c13, peg$currPos++) : (s5 = peg$FAILED, 
            0 === peg$silentFails && peg$fail(peg$c14)), s5 !== peg$FAILED ? (peg$reportedPos = s0, 
            s1 = peg$c60(s2, s4), s0 = s1) : (peg$currPos = s0, s0 = peg$c2)) : (peg$currPos = s0, 
            s0 = peg$c2)) : (peg$currPos = s0, s0 = peg$c2)) : (peg$currPos = s0, s0 = peg$c2)) : (peg$currPos = s0, 
            s0 = peg$c2), peg$cache[key] = {
                nextPos: peg$currPos,
                result: s0
        ...
        function peg$parsejoin() {
            var s0, s1, s2, s3, s4, s5, s6, s7, key = 17 * peg$currPos + 16, cached = peg$cache[key];
            return cached ? (peg$currPos = cached.nextPos, cached.result) : (s0 = peg$currPos, 
            40 === input.charCodeAt(peg$currPos) ? (s1 = peg$c56, peg$currPos++) : (s1 = peg$FAILED, 
            0 === peg$silentFails && peg$fail(peg$c57)), s1 !== peg$FAILED ? (s2 = peg$parserelation(), 
            s2 !== peg$FAILED ? (input.substr(peg$currPos, 7) === peg$c61 ? (s3 = peg$c61, peg$currPos += 7) : (s3 = peg$FAILED, 
            0 === peg$silentFails && peg$fail(peg$c62)), s3 !== peg$FAILED ? (s4 = peg$parsepredicate(), 
            s4 !== peg$FAILED ? (input.substr(peg$currPos, 2) === peg$c11 ? (s5 = peg$c11, peg$currPos += 2) : (s5 = peg$FAILED, 
            0 === peg$silentFails && peg$fail(peg$c12)), s5 !== peg$FAILED ? (s6 = peg$parserelation(), 
            s6 !== peg$FAILED ? (41 === input.charCodeAt(peg$currPos) ? (s7 = peg$c13, peg$currPos++) : (s7 = peg$FAILED, 
            0 === peg$silentFails && peg$fail(peg$c14)), s7 !== peg$FAILED ? (peg$reportedPos = s0, 
            s1 = peg$c63(s2, s4, s6), s0 = s1) : (peg$currPos = s0, s0 = peg$c2)) : (peg$currPos = s0, 
            s0 = peg$c2)) : (peg$currPos = s0, s0 = peg$c2)) : (peg$currPos = s0, s0 = peg$c2)) : (peg$currPos = s0, 
            s0 = peg$c2)) : (peg$currPos = s0, s0 = peg$c2)) : (peg$currPos = s0, s0 = peg$c2), 
            s0 === peg$FAILED && (s0 = peg$currPos, 40 === input.charCodeAt(peg$currPos) ? (s1 = peg$c56, 
            peg$currPos++) : (s1 = peg$FAILED, 0 === peg$silentFails && peg$fail(peg$c57)), 
            s1 !== peg$FAILED ? (s2 = peg$parserelation(), s2 !== peg$FAILED ? (input.substr(peg$currPos, 7) === peg$c64 ? (s3 = peg$c64, 
            peg$currPos += 7) : (s3 = peg$FAILED, 0 === peg$silentFails && peg$fail(peg$c65)), 
            s3 !== peg$FAILED ? (s4 = peg$parserelation(), s4 !== peg$FAILED ? (41 === input.charCodeAt(peg$currPos) ? (s5 = peg$c13, 
            peg$currPos++) : (s5 = peg$FAILED, 0 === peg$silentFails && peg$fail(peg$c14)), 
            s5 !== peg$FAILED ? (peg$reportedPos = s0, s1 = peg$c66(s2, s4), s0 = s1) : (peg$currPos = s0, 
            s0 = peg$c2)) : (peg$currPos = s0, s0 = peg$c2)) : (peg$currPos = s0, s0 = peg$c2)) : (peg$currPos = s0, 
            s0 = peg$c2)) : (peg$currPos = s0, s0 = peg$c2)), peg$cache[key] = {
                nextPos: peg$currPos,
                result: s0
            }, s0);
        }
        var peg$result, options = arguments.length > 1 ? arguments[1] : {}, peg$FAILED = {}, peg$startRuleFunctions = {
            ...
            value: ")\\join[",
            description: '")\\\\join["'
        }, peg$c63 = function(fst, pred, snd) {
            return new ThetaJoin(fst, snd, pred);
        }, peg$c64 = ")\\join(", peg$c65 = {
            type: "literal",
            value: ")\\join(",
            description: '")\\\\join("'
        }, peg$c66 = function(fst, snd) {
...
}(), Relation.prototype = Array, window.onload = function() {
